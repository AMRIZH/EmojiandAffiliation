...
If multiple appear, choose the most dominant affiliation."""
    ...
    def load_cache(self, use_cache=True):
        ...
        if use_cache:
            # Find all cache files for DeepSeek
            cache_pattern = os.path.join(CACHE_DIR, "affiliation_cache_deepseek_*.json")
        ...
        self.cache_file = os.path.join(CACHE_DIR, f"affiliation_cache_deepseek_{timestamp}.json")
        self.cache = {}
    ...
    def process_csv(self, input_file, output_file):
        ...
        print("\n🔍 Analyzing affiliations using DeepSeek LLM...")
